...
print(f"Congrats! You just earned {points} points.")

# loop comprehension
points = 5 if alien_color == 'green' else 10
print(f"Congrats! You just earned {points} points.")

'''Alien Colors #3: Turn your if-else chain from Exercise 5-4 into an if-elif-else
chain.
